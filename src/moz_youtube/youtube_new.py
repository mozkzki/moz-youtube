...
class Youtube:
    ...
    def __init__(
        self,
        token_path: str = "/tmp/moz_youtube_new_token.json",
        credential_path: str = "/tmp/moz_youtube_client_secret.json",
        ...
        self._google_session, logged_in = self.__login()
    ...
    def __load_token(self):
        ...
        if "moz_youtube_new_token_contents" in os.environ:
            # .envから読み込む
            token = json.loads(os.environ["moz_youtube_new_token_contents"])
        elif path.exists():
    ...
    # 期限切れ時刻を更新
    def __update_token_expires_at(self):
    ...
    def _save_credential_from_env(self):
        ...
        credential = os.environ.get("moz_youtube_client_secret_contents", "dummy")
